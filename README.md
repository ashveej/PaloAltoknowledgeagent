...
- **Editable decks** (light theme matching the app — open in PowerPoint/Keynote, or
  **import into Google Slides**: Drive → upload `.pptx` → right-click → *Open with Google Slides*):
  - [`presentation/Executive_Presentation.pptx`](presentation/Executive_Presentation.pptx)
    — technical panel deck (16 slides, structured to the interview agenda with a visual
    architecture diagram).
  - [`presentation/Executive_Presentation_Visual.pptx`](presentation/Executive_Presentation_Visual.pptx)
    — visual / non-technical version (13 slides, charts).
- **Expected panel Q&A:** [`presentation/Expected_QandA.md`](presentation/Expected_QandA.md).
- Decks are generated by `build_deck.py` / `build_visual_deck.py`; live HTML versions
  (`slides.html`, `presentation.html`) present in a browser.
- **Google Slides link:** _<add your link here once uploaded>_

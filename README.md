...
- **Editable deck:** [`presentation/Executive_Presentation.pptx`](presentation/Executive_Presentation.pptx)
  (17 slides). Opens in PowerPoint/Keynote, or **import into Google Slides**
  (Drive → upload the `.pptx` → right-click → *Open with Google Slides*).
- **Present live in a browser:** [`presentation/slides.html`](presentation/slides.html)
  (technical) or [`presentation/presentation.html`](presentation/presentation.html) (visual)
  — arrow keys to navigate.
- Generated by [`presentation/build_deck.py`](presentation/build_deck.py); outline in

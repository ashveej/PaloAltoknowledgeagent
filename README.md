...
- **Product & technical spec:** [`specs/product_and_technical_spec.md`](specs/product_and_technical_spec.md)
- **Evaluation results:** [`pipeline_and_tests/REPORT.md`](pipeline_and_tests/REPORT.md)
- **Sample questions:** [`specs/sample_questions.md`](specs/sample_questions.md)
